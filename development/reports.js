    ...
    e => withThis(
      ...
      obj => [
        ...
        db.patients.toArray(array => makePdf.report(
          'Penerimaan Kasir',
          [
            ['Tanggal', 'No. MR', 'Nama Pasien', 'Layanan', 'Tarif', 'Tindakan', 'Laboratorium','Tambahan', 'Jumlah', 'Kasir'],
            ...
            .map(i => [
              ...
              ...withThis([
                ...
                _.get(i,'rawat.soapDokter.labor') ? _.sum(
                  i.rawat.soapDokter.labor.map(
                    j => +_.get(lookReferences(j.idlabor), 'harga')
                  ) // tagihan laboratory bila ada
                ) : 0,
