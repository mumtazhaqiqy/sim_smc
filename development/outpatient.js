...
_.assign(comp, {
  outpatient: () =>
    !_.includes([2, 3], state.login.peranan)
      ? m("p", "Hanya untuk tenaga medis")
      : m(
          ".content",
          m(
            "h3",
            "Antrian pasien poliklinik " +
              look("klinik", state.login.poliklinik)
          ),
          m(
            ".buttons",
            m(
            ...
            m(
              ...
              m(
                ...
                m(
                  "tbody",
                  {
                    onupdate: () => [
                      ...
                      db.patients.toArray((array) => [
                        (state.clinicQueue = array.filter((i) =>
                          withThis(
                            _.last(i.rawatJalan),
                            (lastOne) =>
                              lastOne &&
                  ...
                  (state.clinicQueue || [])
                    .filter((i) =>
                      state.todayPoliFilter
                        ? withThis(_.last(i.rawatJalan).tanggal, (tanggal) =>
                            between(
                              startOfTheDay(_.now()),
                              tanggal,
                    ...
                    .map((i) =>
                      m(
                        ...
                        tds([
                          ...
                          withThis(_.last(i.rawatJalan), (lastOne) => look("klinik",lastOne.klinik)),
                          i.identitas.no_mr,
  ...
  outPatientHistory: () =>
    m(
      ...
      m(
        ...
        m(
          ...
          m(
            ...
            m(
              "tbody",
              (_.get(state.onePatient, "rawatJalan") || []).map((i) =>
                m(
                  "tr",
                  {
                    onclick: () => [
                      (state.modalVisit =
                        _.includes([2, 3, 4], state.login.peranan) &&
                        ors([i.cara_bayar !== 1, i.bayar_pendaftaran]) &&
                        m(
                          ".box",
                          ...
                          m(
                            ...
                            m(
                              "tr",
                              m("th", "Tanggal"),
                              m("td", hari(i.tanggal, true))
                            ),
                            m(
                              "tr",
                              m("th", "Poliklinik"),
                              m("td", look("klinik", i.klinik))
                            ),
                            m(
                              "tr",
                              m("th", "Cara bayar"),
                          ...
                          m(
                            ...
                            m(
                              ...
                              {
                                onclick: () =>
                                  makePdf.soap(state.onePatient.identitas, i),
                              },
                              makeIconLabel("print", "Cetak SOAP")
                            ),
                            _.get(i.soapDokter, "labor") &&
                              m(
                                ".button.is-info",
                                {
                                  onclick: () =>
                  ...
                  ands([state.login.peranan === 4, !i.bayar_konsultasi]) &&
                    m(
                      "td",
                      m(
                        ".button.is-danger",
                            ...
                            confirm("Yakin hapus riwayat rawat jalan ini?") &&
                              updateBoth(
                                ...
                                _.assign(state.onePatient, {
                                  rawatJalan:
                                    state.onePatient.rawatJalan.filter(
                                      (j) => j.idrawat !== i.idrawat
                                    ),
                                })
                              ),
                          ],
      ...
      m(
        "p.help.has-text-grey-light",
        "Note: Jika pasien umum belum bayar maka tidak dapat diklik"
      ),
